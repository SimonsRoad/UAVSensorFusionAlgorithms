function [x_state, x_t_vec, P_cov,time] = Main_anisotropic_AKF(plotting, Q, R, x_t_vec, x_uav, psi_uav, P_ini)
...
%             x_state(:,k) = x_t_vec;
            ...
            %%% casued by anisotropic jammer pattern
             [x_state(:,k),P_cov(:,:,k),K_EKF_gain(:,k)]=AKF_form(x_vec_all(1,:),x_vec_all(k,:),h_0,P_r_filt_ratio(k,1),x_state_ini,P_cov_ini,F_KF,G_KF,Q_KF,R_KF);
